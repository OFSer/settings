...
let s:blue       = ['#4076B7', 74]
let s:dark_blue  = ['#4076B7', 4]
...
" Standard Syntax
call s:hi('Comment',                   s:base4,      '',         '')
call s:hi('Constant',                  s:red,        '',         '')
call s:hi('String',                    s:orange,     '',         '')
call s:hi('Character',                 s:orange,     '',         '')
call s:hi('Identifier',                s:teal,       '',         'none')
call s:hi('Function',                  s:dark_blue,       '',         'bold')
call s:hi('Statement',                 s:green,      '',         'bold')
call s:hi('Exception',                 s:red,        '',         '')
call s:hi('PreProc',                   s:purple,     '',         'bold')
call s:hi('Define',                    s:purple,     '',         'bold')
call s:hi('Macro',                     s:brown,     '',         'bold')
...
hi Search term=reverse ctermfg=NONE ctermbg=240
...
highlight CocErrorHighlight ctermfg=168 cterm=bold
